        ...
        <div className="container ">
          <div className=" mb-7 flex text-nowrap justify-around  " >
            ...
            <div className="visible basis-4 mb-7 shrink-0">
              <h5 className=" uppercase mb-7 font-bold text-xl ml-0">Company</h5>
              <div className="">
                <ul  className="menu ml-0  ">
                  <li class="mb-3 text-base hover:underline  hover:-translate-x-40 hover:scale-1 hover:transition hover:duration-[1s] hover:ease-in-out   ">
            ...
            <div  className="basis-4 mb-7 shrink-0 ">
              <h5 className=" uppercase mb-7 font-bold text-xl ml-3">Customers</h5>
              <div className="container">
                <ul  className="menu ml-0">
                  <li  className="mb-3 text-base hover:underline">
                  <MdKeyboardArrowRight className='text-neutral-500 text-xl inline' />
            ...
            <div className="visible shrink-0 basis-4 mb-7 ">
              <h5 className=" uppercase mb-7 font-bold text-xl ml-3">Social</h5>
              <div className="container">
                <ul  className="menu">
                  <li  className="mb-3 text-base hover:underline">
